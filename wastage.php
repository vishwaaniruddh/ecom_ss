आप एक गेम खेल रहे हैं जिसमें आप बिक्री के लिए विभिन्न उत्पादों के सही खुदरा मूल्य का अनुमान लगाने की कोशिश करते हैं। किसी सूची में प्रत्येक उत्पाद की कीमत का अनुमान लगाने के बाद, आपको उनके वास्तविक मूल्यों द्वारा छांटे गए उत्पादों की एक ही सूची दिखाई जाती है, कम से कम सबसे महंगी से। (कोई भी दो उत्पाद एक ही राशि खर्च नहीं करते हैं।) इस आदेश के आधार पर, आपको एक या एक से अधिक अनुमान बदलने का मौका दिया जाता है।


आपके कार्यक्रम को उत्पादों के सबसे छोटे सेट का उत्पादन करना चाहिए जैसे कि, यदि आप उन उत्पादों के लिए अपनी कीमतें बदलते हैं, तो आपके अनुमानों का क्रम उत्पाद सूची के सही क्रम के अनुरूप होगा। लौटे सेट में उत्पादों को वर्णमाला क्रम में सूचीबद्ध किया जाना चाहिए। यदि कई छोटे सेट हैं, तो उस सेट को आउटपुट करें जो पहले वर्णानुक्रम में होता है।


यदि सही ऑर्डरिंग है <कोड> कोड जॉब फू बार जार </ कोड>, तो आपको सही ऑर्डर देने के लिए अपनी दो कीमतों को बदलने की आवश्यकता होगी। आप पढ़ने के लिए एक अनुमान लगा सकते हैं <code> job = $ 30 </ code> और दूसरा अनुमान पढ़ने के लिए <code> बार = $ 50 </ code>, जो सही क्रम से मेल खाएगा और आउटपुट सेट <code> बार नौकरी < / कोड>। हालाँकि, आउटपुट सेट <कोड> बार कोड </ कोड> <code> बार जॉब </ कोड> से पहले आता है, और आप इन वस्तुओं के लिए अपने अनुमानों को बदलकर सही क्रम का मिलान कर सकते हैं। 
...
if(get_booking_date($sku)){
 ...
 var_dump($block_date1);
  var_dump($block_date2);
...
<form method="post" style="margin-bottom: 0;" enctype="multipart/form-data" >
	...
	<input type="hidden" name="deposite_amount"  value="<?php echo $deposit;?>">
...
echo '$end'.$end =  date('m/d/Y', strtotime($start_date. ' + ' . $days .' days'));
...
$(function(){
       $('input[name="daterange"]').daterangepicker({
        ...
        for (i = 0; i < array.length; i++) {            
            if (date.format('YYYY-MM-DD') == array[i]) {
                return true; 
                }
            }
        }
