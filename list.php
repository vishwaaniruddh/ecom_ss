...
<!--						</span>-->
						...
						<span class="s-text8 p-t-5 p-b-5">
                            ...
                            <div class="dropdown-menu" aria-labelledby="pricefilter">
                                <!--<a class="dropdown-item" href="?id=<?php echo $product_id;?>&type=<?php echo $product_type;?>&pricefilter=3">Popular</a>-->
                                <a class="dropdown-item" href="?id=<?php echo $product_id;?>&type=<?php echo $product_type;?>&pricefilter=1">Higher To Lower</a>
                                <a class="dropdown-item" href="?id=<?php echo $product_id;?>&type=<?php echo $product_type;?>&pricefilter=2"> Lower To Higher</a>
                              </div>
                            </div>
						</span>
    ...
    <span class="col-sm-12" style="display: flex;
    justify-content: flex-end;">
    
<a href="javascript:prevPage()" class="btn btn-warning" id="btn_prev" style="margin-right:10px;">Prev</a>
<a href="javascript:nextPage()" class="btn btn-warning" id="btn_next">Next</a>
...
// function get_data(){
        $.ajax({
            type: "POST",
            url: 'list_json.php',
            data: 'id='+id+'&type='+type+'&pricefilter='+pricefilter+'&viewall='+viewall,
    ...
    console.log(msg);
                   ...
                   var msg_length  = msg.length;
                    ...
                    for(i=0;i<=19;i++){
                            ...
                            name = msg[i].product_name;
                            selling_price = msg[i].selling_price;
                            rent_price = msg[i].rent_price;
                            image = msg[i].image;
                            sku = msg[i].sku;
                            deposite = msg[i].deposite;
                            discount = msg[i].discount;
                            link = msg[i].link;
                            booking = msg[i].booking;
                            
                            var ht = '<div class="col-md-3 ftco-animate fadeInUp ftco-animated product_col"><div class="product"><a href="'+link+'" class="img-prod"><img class="img-fluid product_img" style="height:350px;" src="'+image+'" alt="Colorlib Template" data-pagespeed-url-hash="2897450385" onload=""></a><div class="text py-3 px-3"><h3><a href="'+link+'">'+name+'</a></h3><hr><div class="subpart"><p style="display:block;">MRP ₹ '+selling_price+'</p><h6 style="color:red;">SKU : <a href="#">'+sku+'</a></h6><div class="d-flex"><div class="pricing"><p class="price"><span class="mr-2 price-dc">Rent ₹ <strong>'+rent_price+'</strong> : for 3 Days</span><br><span class="price-sale">Deposit ₹ <strong>'+deposite+'</strong></span></p></div><div class="rating"><p class="text-right"><a href="#"><span class="ion-ios-star-outline"></span></a><a href="#"><span class="ion-ios-star-outline"></span></a><a href="#"><span class="ion-ios-star-outline"></span></a><a href="#"><span class="ion-ios-star-outline"></span></a><a href="#"><span class="ion-ios-star-outline"></span></a></p></div></div><div class="here">'+booking+'</div></div></div></div></div>';
...
$("#btn_next").on('click',function(){
   ...
   $('.loader').css('display','block');
      ...
      var page_count = Math.ceil(msg.length / records_per_page); 
         ...
         if(current_page != '1' || current_page != 1){
             ...
             for(j=current_page;j<=page_count;j++){
                 if(current_page == j ){
                     max = j*20 ;
                     max = max-1 ;
                     min = max-19 ;
