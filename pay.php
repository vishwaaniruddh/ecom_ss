...
<html>
    <head>
        ...
        <script type="text/javascript" src="yn/js/memenu.js"></script>
                    	...
                    	<form action="#" id="payment_form">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  ...
                                  <input type="text" class="form-control" id="amount" placeholder="amount" name="amount" value="<? echo sprintf("%.2f", $_SESSION['total_rental']) ;?>" readonly / >
                                </div>
                            </div>
...
setInterval(function(){
    ...
    if(document.getElementById("timer").innerHTML == "EXPIRED") {
        ...
        window.location='http://srishringarr.com';
