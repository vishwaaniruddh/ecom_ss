...
if(get_booking_date($sku)){
    ...
    $block_date[] =date('Y-m-d', strtotime('0 days', strtotime($booking_date)));
        			...
        			<div class="flex-w flex-sb" >
        				<div class="w-size13 p-t-0 respon5">
                            ...
                            <div class="app-figure" id="zoom-fig">
                                ...
                                >
                                    <img class="product_image" src="<?php echo $path; ?>" srcset="<?php echo $path; ?>?h=800 2x"/>
                                </a>
                                <div class="selectors">
                                    <?php 
                                        if($type=="1")
...
$ytcode=$ytendarray[0];
echo "<iframe width=\"100%\" height=\"500px\" src=\"https://www.youtube.com/embed/$ytcode\" frameborder=\"0\" allowfullscreen></iframe>";        				    
        				}
        				...
        				<div class=" bo9 w-size14 p-t-0 respon5 p-b-0 ">
					        <div class=" p-l-20 p-r-20 p-t-20 p-b-20 mainbox">	
                                ...
                                ?>
                                   ...
                                   ?> 
                                  <span class="p-b-10" style="color:#E6BE6E	;">MRP:<?php echo $rero[0]; ?></span>
	...
	if($('#dateRangeP').val()==''){
	    ...
	    $.ajax({
           type: 'POST',    
            ...
            data:'pid='+pid+'&type='+type+'&qty='+qty+'&rent_date='+dateRangeP_arr[0]+'&return_date='+dateRangeP_arr[1]+'&price='+price+'&deposit='+deposit+'&sales_price='+sales_price+'&image='+image,
